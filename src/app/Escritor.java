...
public class Escritor implements Runnable{
	...
	public void run() {
		if(implementacao == 1) leitorEescritor();
			...
			try {
				...
				if(implementacao == 3) leitorEescritor2();
			}
	}
	...
	/*implementação com leitor/escritor com prioridade ao escritor*/
	private void leitorEescritor2() {
		controlador.comecarEscrita2();
		bdEsleep();
		controlador.pararEscrita();
	}
